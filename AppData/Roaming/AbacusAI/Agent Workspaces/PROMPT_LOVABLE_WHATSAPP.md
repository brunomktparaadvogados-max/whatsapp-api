...
**URL Base da API:** `https://whatsapp-api-latest-iqxz.onrender.com`
...
```typescript
const API_BASE_URL = 'https://whatsapp-api-latest-iqxz.onrender.com';
...
2. Confirme que a API está online: https://whatsapp-api-latest-iqxz.onrender.com
